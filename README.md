...
### I build tools that make dev workflows faster — from AI-native editors to backend systems that don't fall over under load.

Full-stack systems, AI-integrated developer tools, and architectures built for scale and speed.
...
I like problems where real-time data, AI, and system design collide. Give me a live data feed and I'll find a way to make it fast, cached, and reliable. Give me a backend, and I'll obsess over making it consistent, secure, and resilient.

- 🤖 Building **AI-native developer tools** — editors, agents, and automation pipelines
